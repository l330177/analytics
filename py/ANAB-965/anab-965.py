...
import time
red_engine = create_engine('redshift+psycopg2://admin:whaterver@trs-redshift-cluster.czlcstchuzge.us-east-1.redshift.amazonaws.com:45439/analytics')
PATH = 'C:\QlikDataFiles\ANAB-965'
#%%
eDate = time.strftime("%Y-%m-%d")
#%%
def getRst():
    query = """
select inapppid as Product_ID,
...
when 'fc85ccd942844f61a9c4a7' then 'Exxon mobile'
...
print csvToHtml('C:\QlikDataFiles\gear_kpi\Gear KPI.csv')
